...
const { getGameModeEmoji, getGameModeLabel, GAME_MODES } = require('../utils/emojiManager');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = buildResultsEmbed({
      ...
      previousRank,
      region,
      icon: getGameModeEmoji(gamemodeKey),
      gamemodeLabel: getGameModeLabel(gamemodeKey),
    });
