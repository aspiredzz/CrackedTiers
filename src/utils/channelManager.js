// ============================================================
// CDTIERS Bot - Channel Manager
// Grants/revokes access to the private queue channel so that only
// staff and currently-queued players can see it.
// ============================================================

const { logger } = require('./logger');

/** Grants a member access to the private queue channel. */
...
/** Revokes a member's access to the private queue channel. */
