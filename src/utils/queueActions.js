...
async function joinQueue(interaction) {
  ...
  const replyMessage = state.is_open
    ? `✅ You have joined the testing queue! Your position: **${position}**.`
    : `✅ You have joined the waitlist! Your position: **${position}**. No tester is online yet - you'll be pinged in the private queue channel once one starts.`;
